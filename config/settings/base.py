...
ROOT_DIR = environ.Path(__file__) - 3  # (project_pawz/config/settings/base.py - 3 = project_pawz/)
...
if READ_DOT_ENV_FILE:
    ...
    env.read_env(str(ROOT_DIR.path('.envs')))
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///project_pawz'),
}
...
MIGRATION_MODULES = {
    'sites': 'project_pawz.contrib.sites.migrations'
}
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = 'project_pawz.users.adapters.AccountAdapter'
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = 'project_pawz.users.adapters.SocialAccountAdapter'
